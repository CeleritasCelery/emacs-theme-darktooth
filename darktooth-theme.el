...
(autothemer-deftheme
 ...
 ((default                                   (:foreground darktooth-light0 :background darktooth-dark0))
  ...
  (warning                                   (:foreground darktooth-bright_orange :bold t))
  ...
  ;; MODE SUPPORT: magit
  (magit-section-highlight                   (:background darktooth-dark0_hard))
  (magit-branch-local                        (:foreground darktooth-turquoise4))
  (magit-branch-remote                       (:foreground darktooth-bright_aqua))
  (magit-cherry-equivalent                   (:foreground darktooth-bright_green))
  (magit-cherry-unmatched                    (:foreground darktooth-bright_red))
  (magit-diff-context                        (:foreground darktooth-dark3))
  (magit-diff-context-highlight              (:foreground darktooth-dark4 :background darktooth-dark0_hard))
  (magit-diff-added                          (:foreground darktooth-bright_green :background darktooth-dark_green))
  (magit-diff-added-highlight                (:foreground darktooth-neutral_green :background darktooth-mid_green))
  (magit-diff-removed                        (:foreground darktooth-bright_red :background darktooth-dark_red))
  (magit-diff-removed-highlight              (:foreground darktooth-neutral_red :background darktooth-mid_red))
  (magit-diffstat-added                      (:foreground darktooth-bright_green))
  (magit-diffstat-removed                    (:foreground darktooth-bright_red))
  (magit-diff-file-heading                   (:foreground darktooth-bright_blue :height 1.2))
  (magit-diff-file-heading-highlight         (:foreground darktooth-bright_blue :background darktooth-dark1))
  (magit-diff-file-heading-selection         (:foreground darktooth-bright_blue :background darktooth-mid_blue))
  (magit-diff-hunk-heading                   (:foreground darktooth-light0 :background darktooth-dark2))
  (magit-diff-hunk-heading-highlight         (:foreground darktooth-light0 :background darktooth-dark1))
  (magit-diff-hunk-heading-selection         (:foreground darktooth-light0 :background darktooth-mid_blue))
  (magit-diff-lines-heading                  (:foreground darktooth-light0 :background darktooth-faded_blue))
  (magit-log-author                          (:foreground darktooth-neutral_red))
  (magit-log-date                            (:foreground darktooth-light4))
  (magit-log-graph                           (:foreground darktooth-light2))
  (magit-reflog-amend                        (:foreground darktooth-muted_purple))
  (magit-reflog-checkout                     (:foreground darktooth-bright_blue))
  (magit-reflog-cherry-pick                  (:foreground darktooth-bright_aqua))
  (magit-reflog-commit                       (:foreground darktooth-bright_green))
  (magit-reflog-merge                        (:foreground darktooth-bright_orange))
  (magit-reflog-rebase                       (:foreground darktooth-bright_purple))
  (magit-reflog-remote                       (:foreground darktooth-muted_cyan))
  (magit-reflog-reset                        (:foreground darktooth-bright_red))
  (magit-reflog-other                        (:foreground darktooth-faded_aqua))
  ...
  (magit-section-heading                     (:foreground darktooth-sienna :height 1.4))
  (magit-section-heading-selection           (:foreground darktooth-sienna :background darktooth-mid_blue))
  (magit-signature-bad                       (:foreground darktooth-bright_red))
  (magit-signature-good                      (:foreground darktooth-bright_green))
  (magit-signature-untrusted                 (:foreground darktooth-faded_cyan))
  (magit-signature-expired                   (:foreground darktooth-bright_orange))
  (magit-signature-revoked                   (:foreground darktooth-muted_purple))
  (magit-signature-error                     (:foreground darktooth-neutral_red))
  (magit-tag                                 (:foreground darktooth-faded_yellow))
  (magit-diff-whitespace-warning             (:background darktooth-muted_red))
  (magit-bisect-bad                          (:foreground darktooth-neutral_red))
  (magit-bisect-good                         (:foreground darktooth-neutral_green))
  (magit-bisect-skip                         (:foreground darktooth-neutral_yellow))
  (magit-blame-summary                       (:foreground darktooth-bright_yellow))
  (magit-blame-highlight                     (:background darktooth-dark1 :foreground darktooth-light0))
  (magit-hash                                (:foreground darktooth-dark3))
  (magit-dimmed                              (:foreground darktooth-dark4))
  (magit-sequence-drop                       (:foreground darktooth-neutral_purple))
