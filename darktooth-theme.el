...
(autothemer-deftheme
 ...
 ((default                                   (:foreground darktooth-light0 :background darktooth-dark0))
  ...
  (magit-diff-added                          (:foreground darktooth-light2 :background darktooth-mid_aqua))
  (magit-diff-added-highlight                (:foreground darktooth-light1 :background darktooth-muted_aqua))
  (magit-diff-removed                        (:foreground darktooth-light2 :background darktooth-mid_orange))
  (magit-diff-removed-highlight              (:foreground darktooth-light1 :background darktooth-dark_orange))
  (magit-diffstat-added                      (:foreground darktooth-faded_aqua))
  (magit-diffstat-removed                    (:foreground darktooth-muted_orange))
  (magit-diff-file-heading                   (:foreground darktooth-bright_blue :height 1.2))
  (magit-diff-file-heading-highlight         (:foreground darktooth-bright_blue :background darktooth-dark2))
  (magit-diff-file-heading-selection         (:foreground darktooth-bright_blue :background darktooth-mid_blue))
  (magit-diff-hunk-heading                   (:foreground darktooth-light0 :background darktooth-dark1))
  (magit-diff-hunk-heading-highlight         (:foreground darktooth-light0 :background darktooth-dark2))
  ...
  (magit-reflog-cherry-pick                  (:foreground darktooth-bright_green))
  (magit-reflog-commit                       (:foreground darktooth-bright_green))
  (magit-reflog-merge                        (:foreground darktooth-bright_green))
  (magit-reflog-rebase                       (:foreground darktooth-muted_purple))
  (magit-reflog-remote                       (:foreground darktooth-muted_cyan))
  (magit-reflog-reset                        (:foreground darktooth-bright_red))
  (magit-reflog-other                        (:foreground darktooth-faded_cyan))
