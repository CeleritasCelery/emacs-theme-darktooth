...
(defmacro darktooth-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme ,name ,description ,palette
     ((Man-overstrike                            (:foreground darktooth-bright-red :bold t))
      ...
      (org-level-1                               (:foreground darktooth-bright-orange :height 1.7))
      (org-level-2                               (:foreground darktooth-bright-green :height 1.5))
      (org-level-3                               (:foreground darktooth-bright-blue :height 1.3))
      (org-level-4                               (:foreground darktooth-bright-yellow :height 1.1))
