...
(defmacro darktooth-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme ,name ,description ,palette
     ((Man-overstrike                            (:foreground darktooth-bright-red :bold t))
      ...
      (ansi-color-black                          (:foreground darktooth-black))
      (ansi-color-blue                           (:foreground darktooth-neutral-blue))
      (ansi-color-cyan                           (:foreground darktooth-neutral-cyan))
      (ansi-color-green                          (:foreground darktooth-neutral-green))
      (ansi-color-magenta                        (:foreground darktooth-neutral-purple))
      (ansi-color-red                            (:foreground darktooth-neutral-red))
      (ansi-color-white                          (:foreground darktooth-foreground-1))
      (ansi-color-yellow                         (:foreground darktooth-neutral-yellow))
      (ansi-default-bg-color                     (:background darktooth-background-0))
      (ansi-default-fg-color                     (:foreground darktooth-foreground-0))
      ...
      (avy-lead-face                             (:foreground darktooth-foreground-0 :background darktooth-bright-red))
      (avy-lead-face-0                           (:foreground darktooth-foreground-0 :background darktooth-bright-blue))
      (avy-lead-face-1                           (:foreground darktooth-foreground-0 :background darktooth-bright-aqua))
      (avy-lead-face-2                           (:foreground darktooth-foreground-0 :background darktooth-bright-purple))
      ...
      (company-tooltip-annotation-selection      (:foreground darktooth-foreground-0 :background darktooth-faded-blue :weight 'bold))
      (company-tooltip-common                    (:foreground darktooth-foreground-0 :background darktooth-background-1 :weight 'bold))
      ...
      (csv-separator-face                        (:foreground darktooth-bright-red))
      ...
      (ediff-even-diff-A                         (:background darktooth-background-2))
      (ediff-even-diff-B                         (:inherit 'ediff-even-diff-A))
      (ediff-even-diff-C                         (:inherit 'ediff-even-diff-A))
      (ediff-fine-diff-A                         (:background darktooth-faded-yellow))
      ...
      (font-lock-constant-face                   (:foreground darktooth-bright-purple))
      (font-lock-doc-face                        (:inherit 'font-lock-string-face))
      (font-lock-function-name-face              (:foreground darktooth-bright-yellow))
      (font-lock-keyword-face                    (:foreground darktooth-sienna))
      (font-lock-negation-char-face              (:foreground darktooth-neutral-red :bold t))
      (font-lock-preprocessor-face               (:inherit 'font-lock-builtin-face))
      (font-lock-regexp-grouping-backslash       (:inherit 'font-lock-constant-face :bold t))
      (font-lock-regexp-grouping-construct       (:bold t))
      (font-lock-string-face                     (:foreground darktooth-bright-green))
      (font-lock-type-face                       (:foreground darktooth-bright-aqua))
      (font-lock-variable-name-face              (:foreground darktooth-aquamarine4))
      (font-lock-warning-face                    (:foreground darktooth-neutral-orange :bold t))
      ...
      (git-commit-summary                        (:foreground darktooth-foreground-2))
      ...
      (git-gutter:separator                      (:foreground darktooth-bright-cyan))
      (git-gutter:unchanged                      (:foreground darktooth-bright-yellow))
      ...
      (ivy-current-match                         (:background darktooth-faded-blue))
      (ivy-highlight-face                        (:foreground darktooth-neutral-yellow))
      (ivy-match-required-face                   (:foreground darktooth-bright-red))
      (ivy-minibuffer-match-face-1               (:background darktooth-background-1))
      (ivy-minibuffer-match-face-2               (:background darktooth-muted-yellow))
      ...
      (lazy-highlight                            (:background darktooth-background-2))
      ...
      (magit-bisect-bad                          (:foreground darktooth-neutral-red))
      (magit-bisect-good                         (:foreground darktooth-neutral-green))
      (magit-bisect-skip                         (:foreground darktooth-neutral-yellow))
      ...
      (magit-blame-highlight                     (:background darktooth-background-blue :foreground darktooth-foreground-0))
      ...
      (magit-cherry-equivalent                   (:foreground darktooth-bright-green))
      (magit-cherry-unmatched                    (:foreground darktooth-bright-red))
      ...
      (magit-diff-added-highlight                (:foreground darktooth-neutral-green :background darktooth-mid-green))
      (magit-diff-context                        (:foreground darktooth-background-3 :background 'unspecified))
      (magit-diff-context-highlight              (:foreground darktooth-background-4 :background darktooth-background-0-hard))
      (magit-diff-del                            (:foreground darktooth-bright-red))
      (magit-diff-file-heading             (:foreground darktooth-bright-blue :height 1.2))
      (magit-diff-file-heading-highlight         (:foreground darktooth-bright-blue :background darktooth-background-1))
      (magit-diff-file-heading-selection         (:foreground darktooth-bright-blue :background darktooth-mid-blue))
      (magit-diff-hunk-header                    (:foreground darktooth-neutral-aqua))
      (magit-diff-hunk-heading                   (:foreground darktooth-foreground-0 :background darktooth-background-2))
      (magit-diff-hunk-heading                   (:inherit 'diff-hunk-header))
      (magit-diff-hunk-heading-highlight         (:foreground darktooth-foreground-0 :background darktooth-background-1))
      (magit-diff-hunk-heading-highlight         (:foreground darktooth-foreground-1 :background darktooth-background-3))
      (magit-diff-hunk-heading-selection         (:foreground darktooth-foreground-0 :background darktooth-mid-blue))
      (magit-diff-lines-heading                  (:foreground darktooth-foreground-0 :background darktooth-faded-blue))
      ...
      (magit-diff-removed-highlight              (:foreground darktooth-neutral-red :background darktooth-mid-red))
      (magit-diff-whitespace-warning             (:background darktooth-muted-red))
      (magit-diffstat-added                      (:foreground darktooth-bright-green))
      (magit-diffstat-removed                    (:foreground darktooth-bright-red))
      ...
      (magit-section-heading-selection                     (:foreground darktooth-sienna :background darktooth-background-blue :height 1.4))
      (magit-section-highlight                   (:background darktooth-background-0-hard))
      ...
      (magit-signature-error                     (:foreground darktooth-neutral-red))
      (magit-signature-expired                   (:foreground darktooth-bright-orange))
      (magit-signature-good                      (:foreground darktooth-bright-green :weight 'bold))
      (magit-signature-none                      (:foreground darktooth-faded-red))
      (magit-signature-revoked                   (:foreground darktooth-muted-purple))
      ...
      (match                                     (:background darktooth-background-2))
      ...
      (mode-line                                 (:foreground darktooth-foreground-1 :background darktooth-background-2 :box nil))
      (mode-line-buffer-id                       (:foreground darktooth-bright-aqua))
      (mode-line-inactive                        (:foreground darktooth-foreground-4 :background darktooth-background-0-hard :box nil))
      ...
      (org-block                                 (:background darktooth-background-0-soft))
      (org-block-begin-line                      (:background darktooth-background-0-soft :foreground darktooth-foreground-3))
      ...
      (org-level-1                               (:foreground darktooth-bright-orange :inherit 'variable-pitch :height 1.9))
      (org-level-2                               (:foreground darktooth-bright-green :inherit 'variable-pitch :height 1.8))
      (org-level-3                               (:foreground darktooth-bright-blue :inherit 'variable-pitch :height 1.7))
      (org-level-4                               (:foreground darktooth-bright-yellow :inherit 'variable-pitch :height 1.5))
      (org-level-5                               (:foreground darktooth-faded-aqua :inherit 'variable-pitch :height 1.4))
      (org-level-6                               (:foreground darktooth-bright-green :inherit 'variable-pitch :height 1.3))
      (org-level-7                               (:foreground darktooth-bright-red :inherit 'variable-pitch :height 1.2))
      (org-level-8                               (:foreground darktooth-bright-blue :inherit 'variable-pitch :height 1.1))
      (org-link                                  (:foreground darktooth-bright-yellow :inherit 'variable-pitch :underline t))
      ...
      (org-roam-link                             (:foreground darktooth-bright-aqua :weight 'bold))
      ...
      (org-table                                 (:foreground darktooth-bright-aqua))
      ...
      (table-cell                                (:foreground darktooth-faded-blue))
      ...
      (warning                                   (:foreground darktooth-bright-orange :bold t))
